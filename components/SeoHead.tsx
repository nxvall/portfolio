...
const defaultMeta = {
  title: 'NovL',
  siteName: 'NovL',
  desc: 'NovL is one of the developers in Indonesia. My name is Vall, feel free to say hi.',
  // change base url of your web (without '/' at the end)
  url: 'https://nvhitori.vercel.app',
  type: 'website',
  // change to follow, index if you want to
  robots: 'nofollow, noindex',
  image: 'https://nvhitori.vercel.app/images/pages/profile.jpg',
  author: 'NovL',
};
...
export default function SeoHead(props: {
  ...
  return (
    <Head>
      ...
      <meta name="twitter:site" content="@nvhitori_id" />
